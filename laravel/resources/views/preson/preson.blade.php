...
<link rel="stylesheet" type="text/css" href="{{URL::asset('')}}style/css/manhuaDate.1.0.css">
	<script type="text/javascript" src="{{URL::asset('')}}style/js/jquery.min.js"></script>
	<script type="text/javascript" src="{{URL::asset('')}}style/js/manhuaDate.1.0.js"></script>
	<script type="text/javascript" src="{{URL::asset('')}}style/js/jquery-1.7.2.min.js"></script>
		...
		<div class="pageTop">
			<div class="page">
				<img src="{{URL::asset('')}}style/img/coin02.png" /><span><a href="{{url('index/index')}}">首页</a>&nbsp;-&nbsp;<a
					href="{{url('Preson/preson')}}">个人管理</a>&nbsp;-</span>&nbsp;个人信息
			</div>
		</div>
