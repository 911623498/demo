   ...
   ');
    ...
    public function test_tokenizeHTML_singleAttribute()
    {
        $this->assertTokenization(
            '<br style1="&amp;" />',
            array(
                new HTMLPurifier_Token_Empty('br', array('style1' => '&'))
            )
        );
    }
    ...
    {
        $extra = array(
                // PH5P doesn't seem to like style1 tags
                'PH5P' => false,
                // DirectLex defers to RemoveForeignElements for textification
                'DirectLex' => array(
                    new HTMLPurifier_Token_Start('style1', array('type' => 'text/css')),
                    new HTMLPurifier_Token_Comment("\ndiv {}\n"),
                    new HTMLPurifier_Token_End('style1'),
                ),
            );
