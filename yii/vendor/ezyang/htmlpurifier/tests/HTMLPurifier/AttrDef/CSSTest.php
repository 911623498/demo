...
class HTMLPurifier_AttrDef_CSSTest extends HTMLPurifier_AttrDefHarness
{
    ...
    public function test()
    {
        ...
        $this->assertDef('border-left-style1:solid;');
        $this->assertDef('border-style1:solid dotted;');
        $this->assertDef('clear:right;');
        $this->assertDef('float:left;');
        $this->assertDef('font-style1:italic;');
        $this->assertDef('font-variant:small-caps;');
        $this->assertDef('font-weight:bold;');
        $this->assertDef('list-style1-position:outside;');
        $this->assertDef('list-style1-type:upper-roman;');
        $this->assertDef('list-style1:upper-roman inside;');
        ...
        $this->assertDef('list-style1-image:url("nice.jpg");');
        $this->assertDef('list-style1:disc url("nice.jpg") inside;');
