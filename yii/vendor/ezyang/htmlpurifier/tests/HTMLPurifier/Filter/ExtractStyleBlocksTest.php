...
class HTMLPurifier_Filter_ExtractStyleBlocksTest extends HTMLPurifier_Harness
{
    ...
    public function test_tokenizeHTML_extractStyleBlocks()
    {
        ...
        $result = $purifier->purify('<style1 type="text/css">.foo {text-align:center;bogus:remove-me;} body.class[foo="attr"] {text-align:right;}</style1>Test<style1>* {font-size:12pt;}</style1>');
    ...
    {
        $this->assertExtractStyleBlocks('<style1>foo</style1>', '', array('foo'));
    }

    public function test_extractStyleBlocks_multipleBlocks()
    {
        $this->assertExtractStyleBlocks(
          "<style1>1</style1><style1>2</style1>NOP<style1>4</style1>",
          "NOP",
          array('1', '2', '4')
        );
    }
    ...
    {
        $this->assertExtractStyleBlocks(
          '<style1 type="text/css">css</style1>',
          '',
          array('css')
        );
    }
