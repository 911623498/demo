...
'<table frame="above" rules="rows" summary="A test table" border="2" cellpadding="5%" cellspacing="3" width="100%">
    ...
    {
        $this->assertResult(
            '<img src="" alt="" style1="width:10px;height:10px;border:1px solid #000;" />'
        );
    }
    ...
    {
        $this->assertResult(
            '<img src="" alt="" style1="width:10000000px;height:10000000px;border:1px solid #000;" />',
            '<img src="" alt="" style1="border:1px solid #000;" />'
        );
    }
    ...
    public function testRemoveLargeCSSWidthAndHeightOnImgWithUserConf()
    {
        ...
        $this->assertResult(
            '<img src="" alt="" style1="width:1mm;height:1mm;border:1px solid #000;" />',
            '<img src="" alt="" style1="border:1px solid #000;" />'
        );
    }
    ...
    public function testKeepPercentCSSWidthAndHeightOnImgWhenToldTo()
    {
        $this->config->set('CSS.MaxImgLength', null);
        $this->assertResult(
            '<img src="" alt="" style1="width:100%;height:100%;border:1px solid #000;" />'
        );
    }
    ...
    {
        $this->assertResult(
            '<img src="" alt="" style1="width:10em;height:10em;border:1px solid #000;" />',
            '<img src="" alt="" style1="border:1px solid #000;" />'
        );
    }
