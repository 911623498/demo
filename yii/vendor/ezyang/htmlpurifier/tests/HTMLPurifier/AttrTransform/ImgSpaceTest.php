...
class HTMLPurifier_AttrTransform_ImgSpaceTest extends HTMLPurifier_AttrTransformHarness
{
    ...
    public function testVerticalBasicUsage()
    {
        $this->assertResult(
            array('vspace' => '1'),
            array('style1' => 'margin-top:1px;margin-bottom:1px;')
        );
    }
    ...
    public function testLenientHandlingOfInvalidInput()
    {
        $this->assertResult(
            array('vspace' => '10%'),
            array('style1' => 'margin-top:10%px;margin-bottom:10%px;')
        );
    }
    ...
    {
        $this->assertResult(
            array('vspace' => '23', 'style1' => 'font-weight:bold;'),
            array('style1' => 'margin-top:23px;margin-bottom:23px;font-weight:bold;')
        );
    }
    ...
    public function testHorizontalBasicUsage()
    {
        ...
        $this->assertResult(
            array('hspace' => '1'),
            array('style1' => 'margin-left:1px;margin-right:1px;')
        );
    }
