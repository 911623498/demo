...
class HTMLPurifier_AttrTransform_BgColorTest extends HTMLPurifier_AttrTransformHarness
{
    ...
    public function testBasicTransform()
    {
        $this->assertResult(
            ...
            array('style1' => 'background-color:#000000;')
        );
    }
    ...
    {
        $this->assertResult(
            array('bgcolor' => '#000000', 'style1' => 'font-weight:bold'),
            array('style1' => 'background-color:#000000;font-weight:bold')
        );
    }
    ...
    public function testLenientTreatmentOfInvalidInput()
    {
        ...
        $this->assertResult(
            array('bgcolor' => '#F00'),
            array('style1' => 'background-color:#F00;')
        );
    }
