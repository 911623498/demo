...
class HTMLPurifier_TagTransformTest extends HTMLPurifier_Harness
{
    ...
    public function testSimpleWithCSS()
    {
        ...
        $this->assertTransformation(
            $transformer,
            'center', array('class' => 'boom', 'style1'=>'font-weight:bold;'),
            'div', array('class' => 'boom', 'style1'=>'text-align:center;font-weight:bold;'),
            array('style1'=>'text-align:center;')
        );
        ...
        $this->assertTransformation(
            ...
            'div', array('style1'=>'text-align:center;font-weight:bold;'),
            array('style1'=>'text-align:center;')
        );
    ...
    protected function assertSizeToStyle($transformer, $size, $style)
    {
        $this->assertTransformation(
            ...
            'span', array('style1' => 'font-size:' . $style . ';')
        );
    }
    ...
    public function testFont()
    {
        ...
        $this->assertTransformation(
            ...
            'span', array('style1' => 'font-family:Arial;')
        );
        ...
        $this->assertTransformation(
            ...
            'span', array('style1' => 'color:red;font-family:Arial;font-size:xx-large;')
        );
    }
}
