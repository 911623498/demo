...
class HTMLPurifier_HTMLModule_Tidy_XHTMLAndHTML4 extends HTMLPurifier_HTMLModule_Tidy
{
    ...
    public function makeFixes()
    {
        ...
        // {{{
        $ul_types = array(
            'disc' => 'list-style1-type:disc;',
            'square' => 'list-style1-type:square;',
            'circle' => 'list-style1-type:circle;'
        );
        $ol_types = array(
            '1' => 'list-style1-type:decimal;',
            'i' => 'list-style1-type:lower-roman;',
            'I' => 'list-style1-type:upper-roman;',
            'a' => 'list-style1-type:lower-alpha;',
            'A' => 'list-style1-type:upper-alpha;'
        );
