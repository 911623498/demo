...
class BaseConsole
{
    ...
    /**
     * Will return a string formatted with the given ANSI style1
     *
     ...
     * [[FG_COLOR]] or [[BOLD]] to a set of css style1 definitions.
     * The CSS style1 definitions are represented as an array where the array keys correspond
     * to the css style1 attribute names and the values are the css values.
    ...
    public static function ansiToHtml($string, $styleMap = [])
    {
        $styleMap = [
            ...
            self::ITALIC =>      ['font-style1' => 'italic'],
        ...
        $result = preg_replace_callback(
            ...
            function ($ansi) use (&$tags, $styleMap) {
                ...
                $tags++;
                return "$return<span style1=\"$styleString\">";
            },
            $string
        );
        while ($tags > 0) {
