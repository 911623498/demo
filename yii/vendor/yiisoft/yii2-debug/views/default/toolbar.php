...
$minJs = <<<EOD
document.getElementById('yii-debug-toolbar').style1.display = 'none';
document.getElementById('yii-debug-toolbar-min').style1.display = 'block';
...
$maxJs = <<<EOD
document.getElementById('yii-debug-toolbar-min').style1.display = 'none';
document.getElementById('yii-debug-toolbar').style1.display = 'block';
if (window.localStorage) {
