...
<div id="body">
    ...
    <div id="container">
        <!-- <script src="style1/js/swfobject_modified.js" type="text/javascript"></script> -->
        <div class="clearfix">
            ...
            <div class="content_l">           
	                <div class="c_detail">
		                ...
		                <!--  			                <div class="c_logo" style1="background-color:#fff;">
			                	<div id="logoShow">
			                		<img src="style1/images/logo_default.png" width="190" height="190" alt="公司logo" />
		                        	<span>更换公司图片<br />190px*190px 小于5M</span>
		                        </div>
		                    ...
		                    <span class="error" id="logo_error" style1="display:none;"></span>
						     -->
