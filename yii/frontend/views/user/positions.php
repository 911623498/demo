...
<!-- <div class="web_root"  style1="display:none">http://www.lagou.com</div> -->
...
<!--[if lte IE 8]>
    <script type="text/javascript" src="style1/js/excanvas.js"></script>
<![endif]-->
<script type="text/javascript">
...
<div id="body">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
            		...
            		<i></i>
                                	...
                                	<dd><a rel="nofollow" href="index.php?r=user/index">我的简历</a></dd>
                	                	<dd><a href="index.php?r=user/coller">我收藏的职位</a></dd>
                	                	                	<dd><a href="index.php?r=user/delivery">我投递的职位 <span id="noticeNo" class="red">(1)</span></a></dd>
                	                	<dd class="btm"><a href="index.php?r=user/submet">我的订阅</a></dd>
                	<dd><a href="index.php?r=create/index">我要招人</a></dd>
                                                <dd><a href="index.php?r=user/account">帐号设置</a></dd>
	...
	<dd>
		<a href="index.php?r=user/canin">待定简历</a>
	</dd>
	<dd>
		<a href="haveNoticeResumes.html">已通知面试简历</a>
	</dd>
	<dd>
		<a href="index.php?r=user/have">不合适简历</a>
	</dd>
	<dd class="btm">
		<a href="index.php?r=user/autoflie">自动过滤简历</a>
			</dd>
</dl>
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
