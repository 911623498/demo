...
<head>
    ...
    <meta name="author" content="dede58.com 织梦好模板" />
    <!-- <div class="web_root"  style1="display:none">h</div> -->
...
<div id="body">
    ...
    <div id="container">
        ...
        <div class="content">
            <div id="search_box">
                <form id="searchForm" name="searchForm" action="index.php?r=demo/mlist" method="get">
                    <ul id="searchType">
            ...
            <div id="hotList">
                <ul class="hot_pos reset">
                    <li class="clearfix">
                        <div class="hot_pos_l">
                            <div class="mb10">
                                <a href="index.php?r=demo/toudi" target="_blank">运营总监</a>
                                &nbsp;
                    ...
                    <a href="index.php?r=companylist/list" class="btn fr" target="_blank">查看更多</a>
                </ul>
        ...
        <!-- <div id="loginToolBar">
            <div>
                <em></em>
                <img src="style1/images/footbar_logo.png" width="138" height="45" />
...
<div id="footer">
    <div class="wrapper">
        <a href="index.php?r=demo/lian" target="_blank" rel="nofollow">联系我们</a>
...
<!-- <script src="style1/js/wb.js" type="text/javascript" charset="utf-8"></script>
 -->
